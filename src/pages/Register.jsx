    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-100 to-pink-100 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">Start your Chinese learning journey today</p>
        </div>
        ...
        <Card className="shadow-2xl border-2 border-purple-200">
          <CardHeader>
            ...
            <CardDescription>
              Join thousands of learners mastering Chinese vocabulary
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="targetHSK">Target HSK Level</Label>
                <select
                  id="targetHSK"
                  value={formData.targetHSK}
                  onChange={(e) => setFormData({ ...formData, targetHSK: e.target.value })}
              ...
              <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700 py-6 text-lg font-semibold">
                Create Account
              </Button>
            </form>
        ...
        {/* Benefits */}
        <Card className="mt-4 bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-200">
          <CardContent className="pt-4">
            <ul className="text-sm text-gray-700 space-y-1">
              <li>✅ Access to 10,000+ HSK vocabulary words</li>
              <li>✅ AI-powered text analysis</li>
              <li>✅ Personalized learning path</li>
              <li>✅ Daily articles and quizzes</li>
            </ul>
          </CardContent>
        </Card>
      </div>
